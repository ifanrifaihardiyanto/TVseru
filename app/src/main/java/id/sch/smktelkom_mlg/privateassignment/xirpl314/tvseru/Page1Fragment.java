...
import id.sch.smktelkom_mlg.privateassignment.xirpl314.tvseru.adapter.NewMoveiAdapter;
...
public class Page1Fragment extends Fragment {
    ...
    NewMoveiAdapter newMoveiAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflate = inflater.inflate(R.layout.fragment_page1, container, false);
        recyclerView = (RecyclerView) inflate.findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        newMoveiAdapter = new NewMoveiAdapter(this,list,getContext());
        recyclerView.setAdapter(newMoveiAdapter);
    ...
    private void downloadDataSource() {
        String url = "https://api.themoviedb.org/3/movie/top_rated?api_key=c96c586178c4f8a9b5a9f7cb0d0ab3f0&language=en-US&page=1";
        ...
        GsonGetRequest<ResultResponse> myRequest = new GsonGetRequest<ResultResponse>
                (url, ResultResponse.class, null, new Response.Listener<ResultResponse>() {
                    ...
                    public void onResponse(ResultResponse response) {
                        ...
                        newMoveiAdapter.notifyDataSetChanged();
                    }

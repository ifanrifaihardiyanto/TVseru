...
import id.sch.smktelkom_mlg.privateassignment.xirpl314.tvseru.service.VolleyTop;
...
public class Page2Fragment extends Fragment {
   ArrayList<Result> list= new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflate = inflater.inflate(R.layout.fragment_page2, container, false);
        recyclerView = (RecyclerView) inflate.findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        topMovieAdapter = new TopMovieAdapter(this,list,getContext());
    ...
    private void downloadDataSource() {
        ...
        VolleyTop.getInstance(this).addToRequestQueue(myRequest);
    }
